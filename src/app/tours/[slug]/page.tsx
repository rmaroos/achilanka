...
const TOUR_DETAILS: Record<string, TourDetail> = {
  "classic-sri-lanka": {
    ...
    priceNote:
      "per person, based on 2 travellers · all taxes included",
    ...
    quickFacts: [
      {
        label: "Destinations",
        value:
          "Negombo · Sigiriya · Kandy · Nuwara Eliya · Ella · Yala · Mirissa",
      },
      {
        label: "Best months to travel",
        value: "December to April",
      },
      {
        label: "Accommodation",
        value:
          "4-star hotels and one safari lodge. Boutique and 5-star upgrades available on request.",
      },
      {
        label: "Transport",
        value:
          "Private air-conditioned car or van with chauffeur guide, plus two reserved train journeys.",
      },
    ],
    ...
    itinerary: [
      ...
      },
      {
        ...
        title: "Yala → Mirissa",
        description:
          "Coast road west to the south beaches. The rest of the day is yours.",
      },
      {
        day: 10,
...
function EnquirySidebar({
  ...
  const whatsappHref = useMemo(() => {
    ...
    return `https://wa.me/94771234567?text=${encodeURIComponent(
      lines.join("\n"),
    )}`;
  ...
  return (
    <aside className="rounded-2xl border border-stone-100 p-6 shadow-sm lg:sticky lg:top-24">
      ...
      <p className="mt-3 text-center text-xs text-stone-400">
        No account needed. You'll see the full price before any
        payment.
      </p>
      ...
      <p className="text-sm text-stone-500">
        Want something changed — different hotels, an extra day,
          ...
          >
            ...
            >
              ...
              <svg
                viewBox="0 0 24 24"
                fill="none"
                className={`mt-1 h-4 w-4 shrink-0 text-stone-400 transition-transform ${
                  isOpen ? "rotate-180" : ""
                }`}
                aria-hidden="true"
              >
                ...
                <div className="flex flex-wrap gap-5 border-t border-stone-100 bg-stone-50/60 px-5 py-4 pl-[3.75rem] text-xs text-stone-500">
                  ...
                  {day.mealsLabel && (
                    <span className="flex items-center gap-1.5">
                      ...
                      >
                        <path
                          d="M7 3v7a2 2 0 01-2 2v9M7 3v9M5 3v9M17 3v18M17 3c-2.2 0-3.5 1.8-3.5 4.5S14.8 12 17 12"
                          stroke="currentColor"
                          strokeWidth="1.4"
                          strokeLinecap="round"
                          strokeLinejoin="round"
        ...
        return (
          <div key={faq.question}>
            ...
            >
              ...
              <span className="shrink-0 text-lg text-stone-400">
                {isOpen ? "–" : "+"}
              </span>
            </button>

            {isOpen && (
              <p className="px-5 pb-4 text-sm leading-relaxed text-stone-500">
                {faq.answer}
              </p>
            )}
          </div>
      ...
      <div className="mx-auto max-w-7xl px-4 pb-24 pt-14 sm:px-6 lg:grid lg:grid-cols-[1fr_340px] lg:gap-8 lg:px-8">
        <div>
          ...
          <Reveal className="mt-14">
            ...
            <p className="mt-2 text-sm text-stone-500">
              Published on {tour.review.source} under the
              traveller's own account.
            </p>
            ...
            <div className="mt-5 max-w-xl rounded-2xl border border-stone-100 p-6">
              <div className="flex items-center gap-1.5">
                ...
                <span className="ml-1 text-sm font-semibold text-stone-700">
                  {tour.review.rating}/5
                </span>
              </div>
