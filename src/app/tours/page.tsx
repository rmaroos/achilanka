...
const TOURS: Tour[] = [
  {
    ...
    fromPrice: 1290,
    image:
      "https://picsum.photos/seed/achii-classic-sl/800/600",
    interests: [
      "Hill Country",
      "Heritage & Culture",
      "Wildlife",
  ...
  },
  {
    ...
    fromPrice: 145,
    image:
      "https://picsum.photos/seed/achii-sigiriya/800/600",
  ...
  },
  {
    ...
    fromPrice: 95,
    image:
      "https://picsum.photos/seed/achii-yala/800/600",
    interests: ["Wildlife"],
  },
  {
    id: "wildlife-beaches",
    ...
    fromPrice: 980,
    image:
      "https://picsum.photos/seed/achii-wildlife-beach/800/600",
  ...
  },
  {
    ...
    fromPrice: 80,
    image:
      "https://picsum.photos/seed/achii-ella-hike/800/600",
  ...
  },
  {
    ...
    fromPrice: 720,
    image:
      "https://picsum.photos/seed/achii-tea-trails/800/600",
  ...
  },
  {
    ...
    fromPrice: 65,
    image:
      "https://picsum.photos/seed/achii-colombo-food/800/600",
    interests: ["Heritage & Culture"],
  },
  {
    id: "ancient-kingdoms",
    ...
    fromPrice: 860,
    image:
      "https://picsum.photos/seed/achii-ancient-kingdoms/800/600",
    interests: ["Heritage & Culture"],
  },
  {
    id: "surf-coast",
    ...
    fromPrice: 1050,
    image:
      "https://picsum.photos/seed/achii-surf-coast/800/600",
        ...
        <div className="mt-3 flex flex-col gap-1.5 text-sm text-stone-500">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <path
                d="M15.5 6.5a3 3 0 010 5.8M18 19c0-2.4-1.7-4.3-4-4.9"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
              />
  ...
  return (
    <div className="flex flex-col items-center rounded-2xl border border-dashed border-stone-200 px-6 py-16 text-center">
      ...
      <p className="mt-2 max-w-sm text-sm text-stone-500">
        Try widening your price or trip length, or clearing
        an interest so more tours can show up.
      </p>
...
export default function ToursPage() {
  ...
  const filteredTours = useMemo(() => {
    ...
    const result = TOURS.filter((tour) => {
      if (
        filters.type !== "all" &&
        tour.type !== filters.type
      ) {
        return false;
      }

      if (tour.fromPrice > filters.maxPrice) {
        return false;
      }

      if (tour.durationDays > filters.maxDays) {
        return false;
      }
      ...
      if (
        ...
        !filters.interests.some((interest) =>
          tour.interests.includes(interest)
        )
      ) {
        return false;
      }
  ...
  return (
    <main className="min-h-screen bg-white">
      {/* Header comes from app/layout.tsx */}
      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 sm:px-6 lg:px-8">
        ...
        <Reveal className="mt-4">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-stone-500">
            Every tour is operated by us, priced per person
            with taxes included, and can be adjusted before
            you pay. Browse as long as you like — there is no
            account needed to explore or to reserve.
          </p>
        </Reveal>
      </div>
