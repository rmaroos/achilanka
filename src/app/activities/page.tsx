...
type TourLink = { name: string; durationLabel: string; href: string };
...
const EXPERIENCES: Experience[] = [
  {
    ...
    tours: [
      { name: "Classic Sri Lanka", durationLabel: "10 days · 9 nights", href: "/tours/classic-sri-lanka" },
      { name: "Wildlife & Beaches", durationLabel: "8 days · 7 nights", href: "/tours/wildlife-beaches" },
      { name: "Surf & Coast Escape", durationLabel: "9 days · 8 nights", href: "/tours/surf-coast" },
    ],
  },
  {
    id: "hill-country",
    ...
    tours: [
      { name: "Classic Sri Lanka", durationLabel: "10 days · 9 nights", href: "/tours/classic-sri-lanka" },
      { name: "Tea Trails & Hill Country", durationLabel: "6 days · 5 nights", href: "/tours/tea-trails" },
      { name: "Ancient Kingdoms & Heritage", durationLabel: "7 days · 6 nights", href: "/tours/ancient-kingdoms" },
    ],
  },
  {
    id: "wildlife",
    ...
    tours: [
      { name: "Classic Sri Lanka", durationLabel: "10 days · 9 nights", href: "/tours/classic-sri-lanka" },
      { name: "Wildlife & Beaches", durationLabel: "8 days · 7 nights", href: "/tours/wildlife-beaches" },
      { name: "Yala Full-Day Safari", durationLabel: "1 day · dawn to dusk", href: "/tours/yala-safari" },
    ],
  },
  {
    id: "heritage",
    ...
    tours: [
      { name: "Classic Sri Lanka", durationLabel: "10 days · 9 nights", href: "/tours/classic-sri-lanka" },
      { name: "Ancient Kingdoms & Heritage", durationLabel: "7 days · 6 nights", href: "/tours/ancient-kingdoms" },
      { name: "Sigiriya & Dambulla from Colombo", durationLabel: "1 day · approx. 15 hours", href: "/tours/sigiriya-dambulla" },
    ],
  },
  {
    id: "tea-trails",
    ...
    tours: [
      { name: "Classic Sri Lanka", durationLabel: "10 days · 9 nights", href: "/tours/classic-sri-lanka" },
      { name: "Tea Trails & Hill Country", durationLabel: "6 days · 5 nights", href: "/tours/tea-trails" },
      { name: "Ella Hike & Nine Arch Bridge", durationLabel: "1 day · approx. 8 hours", href: "/tours/ella-hike" },
    ],
  },
];
...
const ACCOMMODATION_ITEMS: ServiceItem[] = [
  {
    ...
    description: "Restored villas, plantation bungalows and small owner-run hotels. 8 to 20 rooms.",
  },
  {
    title: "4-star hotels",
    description: "Reliable comfort with pools and air conditioning — the standard on most of our tours.",
  },
  {
    title: "5-star and resorts",
    description: "Beach resorts and luxury tented camps, available as an upgrade on any round tour.",
  },
  {
    title: "Guesthouses",
    description: "Simple, clean, family-run places in the hill country and surf towns.",
  },
];
...
const TRANSPORT_ITEMS: ServiceItem[] = [
  {
    title: "Private car",
    description: "Sedan with a chauffeur guide, comfortable for two travellers with normal luggage.",
  },
  {
    title: "Private van",
    description: "High-roof van for 3 to 6 travellers, with space for surfboards or child seats.",
  },
  {
    title: "Airport transfers",
    description: "Meet and greet inside arrivals at any hour, including 2am landings.",
  },
  {
    title: "Train reservations",
    description: "Reserved seats on the hill country lines, booked the day they open.",
  },
];
            ...
            {NAV_LINKS.map((link) => (
              <a
                ...
                className={`group relative pb-1 transition-colors hover:text-stone-900 ${
                  link.label === "What to Do" ? "text-stone-900" : ""
                }`}
              >
                {link.label}
                <span
                  className={`absolute bottom-0 left-0 h-0.5 bg-amber-400 transition-all duration-300 ${
                    link.label === "What to Do" ? "w-full" : "w-0 group-hover:w-full"
                  }`}
                />
              </a>
            ))}
...
function ExperienceCard({ experience, imageFirst }: { experience: Experience; imageFirst: boolean }) {
  return (
    <Reveal className="overflow-hidden rounded-2xl ring-1 ring-stone-100">
      <div className={`grid grid-cols-1 md:grid-cols-2 ${imageFirst ? "" : "md:[direction:rtl]"}`}>
        ...
        <div className="flex flex-col justify-center p-8 md:[direction:ltr] sm:p-10">
          <p className="text-xs font-semibold uppercase tracking-wide text-stone-400">{experience.eyebrow}</p>
          <h3 className="mt-2 text-2xl font-bold text-stone-900">{experience.title}</h3>
          <p className="mt-3 text-sm leading-relaxed text-stone-500">{experience.description}</p>
          <p className="mt-4 text-xs text-stone-400">Where: {experience.whereLabel}</p>

          <hr className="my-5 border-stone-100" />

          <p className="text-xs font-semibold uppercase tracking-wide text-stone-400">Tours that go here</p>
...
function Experiences() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
      <Reveal>
        <h2 className="text-3xl font-bold text-stone-900">Experiences</h2>
      </Reveal>
      <div className="mt-8 flex flex-col gap-6">
        {EXPERIENCES.map((experience, i) => (
          <ExperienceCard key={experience.id} experience={experience} imageFirst={i % 2 === 0} />
        ))}
      </div>
    </section>
  );
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-6 text-white">
        ...
        <p className="mt-2 text-xs text-stone-200">Best places: {activity.bestPlaces}</p>
        <p className="text-xs text-stone-200">Season: {activity.season}</p>
  ...
  return (
    <section className="bg-stone-50 py-16">
      <Reveal className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-stone-900">Activities</h2>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-stone-500">
          Add any of these to a tour, or tell us which one is the reason for
          the trip and we will build around it. Seasons matter here — the
          two monsoons mean the good coast moves through the year.
        </p>
...
function TravelServices() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
      <Reveal>
        <h2 className="text-3xl font-bold text-stone-900">Travel services</h2>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-stone-500">
          ...
          <ServiceCard
            ...
            icon={
              <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
                <path d="M3.5 18.5v-11M3.5 12h17v6.5M8 12V9a2 2 0 012-2h4a2 2 0 012 2v3" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            }
          />
          <ServiceCard
            ...
            icon={
              <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5">
                ...
                />
                <path d="M4.5 15.5h15v2a1 1 0 01-1 1h-1a1 1 0 01-1-1v-1h-9v1a1 1 0 01-1 1h-1a1 1 0 01-1-1v-2z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
